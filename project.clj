(defproject clj1 "0.1.0-SNAPSHOT"
  ...
  :dependencies [[cheshire "5.6.3"]
                 ...
                 [metosin/compojure-api
                  "1.1.13"
                  :exclusions
                  [commons-codec com.fasterxml.jackson.core/jackson-core]]
  ...
  [["releases"
    {:url
     "https://sforzando.artifactoryonline.com/sforzando/libs-release-local"
     :username [:gpg :env/artifactory_user]
     :password [:gpg :env/artifactory_pwd]}]
   ["plugins"
    {:url "https://sforzando.artifactoryonline.com/sforzando/plugins-release"
     :username [:gpg :env/artifactory_user]
     :password [:gpg :env/artifactory_pwd]}]]
  :container {:name "pochta"
              :dockerfile "/docker"
              :hub "sforzando-dockerv2-local.jfrog.io"}
  :dynamodb-local {:port 6798, :in-memory? true, :shared-db? true}
